...
This is a simple web application that shows you the current weather **and a 5-day forecast** for any city you search for. Type a city name and it will display temperature, humidity, a short description, and a weather emoji — plus a 5-day outlook.
...
4.  **View Weather Information:** The application will then display a card with:
    ...
    - A **5-day forecast** list showing date, emoji, min/max temperatures, and a short label.
